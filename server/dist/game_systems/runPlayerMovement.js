import { BASE_SPEED, DASH_SPEED,
//DASH_TIME,
 } from "./player/player.js";
import { canMoveTo } from "./collisions/collisions.js";
export function runPlayerMovement(players, deltaTime, dungeonMap) {
    ...
    players.forEach((player) => {
        ...
        if (player.isDashing) {
            ...
            const stepDistance = Math.min(maxStep, player.dashDistanceRemaining);
...
//# sourceMappingURL=runPlayerMovement.js.map