        ...
        <div className={styles.dungeonMenuContainer}>
            <div className={styles.dungeonMenuContent}>
                <div className={styles.title}>
                    <div className={styles.dungeonIconContainer} style={{ borderColor: `${colors[dungeon.difficulty.toLowerCase()].hex}`, boxShadow: `0 0 100px ${colors[dungeon.difficulty.toLowerCase()].hex}` }}>
                        <img src={dungeon.icon.src} />
                    </div>
                    <h3 style={{ color: `${colors[dungeon.difficulty.toLowerCase()].hex}` }}>{dungeon.name.toUpperCase()}</h3>
                </div>
